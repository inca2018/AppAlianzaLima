package org.futuroblanquiazul.appalianzalima.Adapter;
...
public class NameAdapter extends ArrayAdapter<Name> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (name.getStatus() == 0)
            imageViewStatus.setBackgroundResource(R.drawable.sync_off);
        else
            imageViewStatus.setBackgroundResource(R.drawable.sync_on);
